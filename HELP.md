...
* The original package name 'shop.wannab.order-payment-service' is invalid and this project uses 'shop.wannab.order_payment_service' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/3.3.12/reference/data/nosql.html#data.nosql.redis)
